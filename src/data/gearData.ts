...
const ZAYIN: Grade = {
  name: "Zayin",
  path: "/appweb-trpr01/images/zayin.webp",
};

const TETH: Grade = {
  name: "Teth",
  path: "/appweb-trpr01/images/teth.webp",
};

const HE: Grade = {
  name: "He",
  path: "/appweb-trpr01/images/he.webp",
};

const WAW: Grade = {
  name: "Waw",
  path: "/appweb-trpr01/images/waw.webp",
};

const ALEPH: Grade = {
  name: "Aleph",
  path: "/appweb-trpr01/images/aleph.webp",
};
