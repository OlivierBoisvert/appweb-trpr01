...
| A13 |   MUST   |   ⬜   | Recherche par nom pour la liste      |       6       | Changement en temp réel de la liste d'équipement en rapport avec la recherche mit                                                               |                   |
| A14 |   MUST   |   ⬜   | Ajout de l'exportation CSV           |      10       | Ajout d'un bouton qui permet l'exportation de la liste complète d'équipement sous forme de CSV                                                  |                   |
